...
create table zonas(codrest int,codzona int,
...
drop table if exists mesas_disponibles;
create table mesas_disponibles
(
	codrest int,
    codzona int,
    fecha date,
...
drop event if exists borraAyer;
delimiter $$
